...
import raytracing.coordinates.RPoint4;
...
public class Point4FX  {
    ...
    public RPoint4 getCPoint4()
    {
        return new RPoint4(x.floatValue(), y.floatValue(), z.floatValue(), w.floatValue());
    }

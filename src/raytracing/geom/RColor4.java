 ...
 * @author user
 */
public class RColor4 extends FloatStruct  implements AbstractCoordinateFloat {
    ...
    public RColor4(float r, float g, float b)
    {
        this.r = r; this.g = g; this.b = b;
        this.w = 1;
    }
    
    public RColor4(float r, float g, float b, float w)
    {
        this(r, g, b);
        this.w = w;
    }
